...
3. **Git Push & Pull Governance**:
   ...
   - **Detailed Commit/PR Documentation**: When explicitly commanded to push/pull or create a commit/PR, create a comprehensive, detailed PR/Commit document (`docs/Release/PR_DESCRIPTION.md`) detailing all changes compared to the last commit/PR across all categories: New Features, Bug Fixes, Quality of Life (QoL) enhancements, Architecture & Design updates, Benchmarks & Performance metrics, Test Count comparison, Security, etc.
...
4. **Comprehensive Deliverables**: Every feature/pull request must include:
   - Detailed GitHub PR Description (`docs/Release/PR_DESCRIPTION.md`) outlining all features added, architecture changes, bug fixes, performance, memory management, and test counts compared to previous commits/PRs.
   - Unit tests
   - Benchmarks
   - Documentation
   - Logging
