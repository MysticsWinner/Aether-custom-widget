...
> **v0.7 Full Design Document**: See [PLAN_0_7.md](file:///d:/Code/Aether-custom-widget/docs/Project/PLAN_0_7.md) for the complete phase-by-phase architecture, key types, integration points, IPC variants, test coverage requirements, and open design questions for all Phases 17–26.
